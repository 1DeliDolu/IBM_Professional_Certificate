...
[X]A product manager is usually a businessperson rather than a visionary.

Correct. A traditional product manager is a businessperson who manages the budget.
...
[X] A project manager is a task master, while the scrum master is a coach.
...
[X]A method for tracking planned items and showing progress as items are moved across the board.
...
[X]They eventually may be moved to the product backlog.

Correct. Items are held in the icebox until you can get back to them.
