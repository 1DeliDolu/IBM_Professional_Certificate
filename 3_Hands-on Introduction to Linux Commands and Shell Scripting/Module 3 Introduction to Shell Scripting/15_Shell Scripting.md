...
Correct! This is the cron job syntax.
...
Correct! This invokes the Bourne shell or other compatible shell program from the bin directory.
...
Correct! Enter crontab -e on the command line to open the default text editor.
...
Correct! Filters are chained together to produce a pipeline.
...
Correct! This symbol redirects an error message to a file.
...
Question 6
 ...
 What symbol is used to define a shell variable?
...
Correct! Use the equal sign to assign a value to your variable name.
...
Correct! This command lists all environment variables.
...
Correct! Scripts are generally slower to run than compiled languages, but they are also much easier and faster to develop.
...
Correct! The pipe symbol allows you to chain together sequences of filter commands.
